            ...
            <li>
              <Details
                ...
                description={[
                  ...
                  ` game invitation links at a time. Sending these links to another user will invite them to the game and allow them to pick a character to use. The user can also delete the game.`,
                ]}
              />
            </li>
          </ol>
